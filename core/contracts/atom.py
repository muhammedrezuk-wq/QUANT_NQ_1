...
SubscribeAllFn = Callable[[Callable[..., Any]], None]
...
class AtomContext:
    ...
    # 1.14.0 — بأمر المالك المباشر 2026-08-19: اشتراك على كل حدث خام بلا تسمية
    # (عيون الذرّة المشرفة). اختياري بقيمة افتراضية None حفاظًا على توافق كل
    # بناءات AtomContext القائمة في الاختبارات والفحوص — الذرّة التي تحتاجه
    # تتحقق منه بنفسها وتعمل بلاه إن غاب (نواة أقدم).
    subscribe_all: SubscribeAllFn | None = None
